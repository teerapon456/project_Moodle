...
<div class="container mt-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/INTEQC_GLOBAL_ASSESMENT/admin/process-import" method="post" enctype="multipart/form-data">
                <ul>
                    <li>
                        <a href="/INTEQC_GLOBAL_ASSESMENT/assets/excel_templates/template.xlsx" download="template.xlsx">

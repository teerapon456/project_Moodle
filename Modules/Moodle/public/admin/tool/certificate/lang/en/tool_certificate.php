...
$string['certificatemanagement'] = 'Certificate Management';
$string['certificatesettings'] = 'Certificates settings';
$string['certificatedashboard'] = 'Certificate Dashboard';
$string['certificatedashboard_totalissued'] = 'Total Issued Certificates';
$string['certificatedashboard_totaltemplates'] = 'Total Certificate Templates';
$string['certificatedashboard_delete'] = 'Delete Certificate';
$string['certificatedashboard_deleteconfirm'] = 'Are you sure you want to delete this issued certificate?';
$string['certificatedashboard_deletesuccess'] = 'Certificate deleted successfully.';
$string['certificatedashboard_deleteerror'] = 'Error: Could not delete the certificate.';
$string['certificatedashboard_updatesuccess'] = 'Certificate updated successfully.';
$string['certificatesissues'] = 'Issued Certificates';
$string['certificatesissues_user'] = 'User';
$string['certificatesissues_email'] = 'Email';
$string['certificatesissues_course'] = 'Course';
$string['certificatesissues_template'] = 'Template';
$string['certificatesissues_issueddate'] = 'Issued Date';
$string['certificatesissues_code'] = 'Code';
$string['certificatesissues_actions'] = 'Actions';
$string['certificatesissues_noissues'] = 'No certificates issued yet.';

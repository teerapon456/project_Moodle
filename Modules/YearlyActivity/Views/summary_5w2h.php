...
<div class="max-w-7xl mx-auto pb-10">
    ...
    <!-- Content Sections Wrapper: Bypasses Tailwind limitations to force 20px gaps -->
    <div class="flex flex-col" style="gap: 20px !important; margin-top: 20px !important;">

        <!-- Main Content: Responsive 5W2H Grid -->
        <div class="grid-5w2h overflow-hidden">

            <!-- What -->
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center g-what">
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-5 h-5 rounded-full bg-blue-100 text-primary flex items-center justify-center font-bold text-[10px]">W</span>
                    <h3 class="font-bold text-gray-700 text-sm">What</h3>
                </div>
                <h4 class="text-base font-bold text-red-700 leading-tight"><?= htmlspecialchars($summary['What'] ?? '-') ?></h4>
                <p class="text-gray-600 text-[11px] mt-1 line-clamp-1"><?= htmlspecialchars($summary['Description'] ?? '-') ?></p>
            </div>

            <!-- Why -->
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center g-why">
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-5 h-5 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center font-bold text-[10px]">W</span>
                    <h3 class="font-bold text-gray-700 text-sm">Why</h3>
                </div>
                <p class="text-gray-600 text-[11px] line-clamp-2"><?= nl2br(htmlspecialchars($summary['Why'] ?? '-')) ?></p>
            </div>

            <!-- How Much -->
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 bg-green-50/50 flex flex-col justify-center g-much">
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-5 h-5 rounded-full bg-green-100 text-green-600 flex items-center justify-center font-bold text-[10px]">H</span>
                    <h3 class="font-bold text-gray-700 text-sm">How Much</h3>
                </div>
                <p class="text-xl font-bold text-green-700"><?= $summary['How Much'] ?></p>
            </div>

            <!-- When -->
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center g-when">
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-5 h-5 rounded-full bg-orange-100 text-orange-600 flex items-center justify-center font-bold text-[10px]">W</span>
                    <h3 class="font-bold text-gray-700 text-sm">When</h3>
                </div>
                <p class="font-bold text-gray-800 text-xs"><?= $summary['When'] ?></p>
            </div>

            <!-- Where -->
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center g-where">
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-5 h-5 rounded-full bg-red-100 text-red-600 flex items-center justify-center font-bold text-[10px]">W</span>
                    <h3 class="font-bold text-gray-700 text-sm">Where</h3>
                </div>
                <p class="text-gray-800 text-xs"><?= htmlspecialchars($summary['Where'] ?? '-') ?></p>
            </div>

            <!-- Key Person -->
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center g-person">
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-5 h-5 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center font-bold text-[10px]">KP</span>
                    <h3 class="font-bold text-gray-700 text-sm">Key Person</h3>
                </div>
                <div class="font-bold text-purple-700 text-xs"><?= htmlspecialchars($activity['key_person_name'] ?? '-') ?></div>
            </div>

            <!-- How (Scope) -->
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center g-how">
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-5 h-5 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center font-bold text-[10px]">H</span>
                    <h3 class="font-bold text-gray-700 text-sm">How (Scope)</h3>
                </div>
                <div class="text-gray-600 text-[11px] line-clamp-1"><?= htmlspecialchars($summary['How'] ?? '-') ?></div>
            </div>

            <!-- Activity Timeline -->
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col min-h-[300px] md:min-h-0 g-timeline">
                <h3 class="text-base font-bold text-gray-800 mb-3 flex items-center gap-2 flex-shrink-0">
                    <i class="ri-history-line"></i> Activity Timeline
                </h3>

                <div class="flex-grow overflow-y-auto scrollbar-thin pr-2 pl-2 relative min-h-0">
                    <?php if (empty($summary['Logs'])): ?>
                        <div class="relative flex gap-4">
                            <div class="w-4 h-4 rounded-full bg-gray-200 border-2 border-white flex-shrink-0"></div>
                            <p class="text-xs text-gray-400 italic">No history logged yet.</p>
                        </div>
                    <?php else: ?>
                        <div class="space-y-4">
                            <?php foreach ($summary['Logs'] as $log): ?>
                                <div class="relative flex gap-4 last:pb-0">
                                    <div class="absolute left-[7px] top-2 bottom-[-16px] w-[2px] bg-red-100 last:hidden"></div>
                                    ...
                                    <div class="flex-grow min-w-0">
                                        <div class="text-[10px] font-bold text-gray-400 uppercase leading-tight">
                                            ...
                                            <?php if ($log['changed_by_name']): ?>
                                                <span class="font-normal normal-case">by <?= htmlspecialchars($log['changed_by_name']) ?></span>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <?php if ($log['note']): ?>
                                            <div class="mt-1 p-1.5 bg-gray-50 rounded border border-gray-100 text-gray-600 text-[10px] italic leading-tight">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-6 border-b border-gray-200 flex justify-between items-center bg-gray-100/50">
                <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-6 border-b border-gray-200 bg-gray-100/50">
                ...
                <div class="relative min-w-[800px]">
                    ...
                    <div class="space-y-4">
                        <?php foreach ($summary['Milestones'] as $ms):
                            ...
                            // 1. Sort by Start Date Ascending (Oldest first for cascading down)
                            ...
                            foreach ($segments as &$seg) {
                                ...
                                foreach ($rows as $rid => $rowEnd) {
                                    // >= allows segments that start exactly when the previous one ends to share the same row
                                    if ($seg['start'] >= $rowEnd) {
                                        $seg['row'] = $rid;
                                        // If instantaneous (start == end), use a tiny virtual width (+1s) for stacking 
                                        // so that another instantaneous change at the same time is forced to a new row.
                                        $rows[$rid] = ($seg['end'] === $seg['start']) ? $seg['end'] + 1 : $seg['end'];
                                        $placed = true;
                                        break;
                                    }
                                }
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-6 border-b border-gray-200 bg-gray-100/50 flex justify-between items-center">
                <div>
        ...
        ?>
            <div class="bg-white p-6 rounded-xl shadow-lg border-2 border-yellow-400/30 bg-yellow-50/10 mb-12">

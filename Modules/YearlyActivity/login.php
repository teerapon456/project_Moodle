...
// Use hardcoded asset path based on standard layout to ensure reliability
$publicUrl = $baseRoot . '/public';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!\Core\Security\CsrfHelper::validateToken($csrfToken)) {
        ...
        $result = $auth->authenticate($username, $password, 'YEARLY_ACTIVITY');
...
<head>
    ...
    <title>เข้าสู่ระบบ - Yearly Activity Tracking (ระบบติดตามกิจกรรมประจำปี)</title>
...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-800">ระบบติดตามกิจกรรมประจำปี</h1>
            <p class="text-gray-600">Yearly Activities Tracking System</p>
        </div>
